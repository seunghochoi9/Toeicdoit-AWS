...
public class QPaymentModel extends EntityPathBase<PaymentModel> {
    ...
    private static final long serialVersionUID = -928622813L;
    ...
    public final EnumPath<site.toeicdoit.tx.enums.PaymentStatus> status = createEnum("status", site.toeicdoit.tx.enums.PaymentStatus.class);
