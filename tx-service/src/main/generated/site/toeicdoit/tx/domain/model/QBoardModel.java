...
public class QBoardModel extends EntityPathBase<BoardModel> {
    ...
    private static final long serialVersionUID = 1896070723L;
    ...
    public final QReplyModel replyId;
    ...
    public QBoardModel(Class<? extends BoardModel> type, PathMetadata metadata, PathInits inits) {
        ...
        this.replyId = inits.isInitialized("replyId") ? new QReplyModel(forProperty("replyId"), inits.get("replyId")) : null;
