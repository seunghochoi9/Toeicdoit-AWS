...
public class QReplyModel extends EntityPathBase<ReplyModel> {
    ...
    private static final long serialVersionUID = 1130292693L;
    ...
    public final ListPath<ReplyModel, QReplyModel> childrenIds = this.<ReplyModel, QReplyModel>createList("childrenIds", ReplyModel.class, QReplyModel.class, PathInits.DIRECT2);
    ...
    public final QReplyModel parentId;
    ...
    public QReplyModel(Class<? extends ReplyModel> type, PathMetadata metadata, PathInits inits) {
        ...
        this.parentId = inits.isInitialized("parentId") ? new QReplyModel(forProperty("parentId"), inits.get("parentId")) : null;
